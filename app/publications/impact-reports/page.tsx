...
export default function ImpactReportsPage() {
  ...
  const reports = [
    { title: "2025 Mid-Year Progress & Outcomes Report", desc: "A detailed review of community care program metrics and digital tracking results.", date: "June 18, 2025, 2:30 PM", link: "/reports/mid-year-2025.pdf", cover: "https://images.unsplash.com/photo-1576091160550-2173dba999ef?auto=format&fit=crop&w=600&h=350&q=80" },
