      ...
      <div className="space-y-20">
        ...
        {(activePhase === "all" || activePhase === "scale") && (
          <section id="scale" className="scroll-mt-24 space-y-10 border-b border-zinc-100 pb-16">
            ...
            {/* Scale Sub-block 1: Longitudinal Care */}
            ...
            {/* Scale Sub-block 2: Collaborative Care */}
            <div className="p-8 sm:p-10 bg-zinc-50/60 border border-zinc-200/80 rounded-3xl space-y-6 shadow-xs">
              <div className="space-y-2">
                <h3 className="text-2xl sm:text-3xl font-bold text-zinc-950 leading-tight">
              ...
              <div className="pt-6 border-t border-zinc-200/80 space-y-3">
                ...
                <div className="grid grid-cols-1 gap-2.5">
                  <a
                    href="https://bmjopen.bmj.com/content/11/8/e048481"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-start gap-3 p-3.5 rounded-xl bg-white border border-zinc-200/80 hover:border-accent-purple/50 hover:bg-zinc-50 transition-colors group"
                  >
                    <FileText className="h-4 w-4 text-accent-purple shrink-0 mt-0.5" />
                    <span className="text-[13.5px] text-zinc-700 group-hover:text-zinc-950 leading-relaxed font-light">
                      Collaborative care model for depression in rural Nepal: a mixed-methods implementation research study. <span className="text-accent-purple font-medium underline break-all">https://bmjopen.bmj.com/content/11/8/e048481</span>
                    </span>
                  </a>

                  <a
                    href="https://pmc.ncbi.nlm.nih.gov/articles/PMC5790311/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-start gap-3 p-3.5 rounded-xl bg-white border border-zinc-200/80 hover:border-accent-purple/50 hover:bg-zinc-50 transition-colors group"
                  >
                    <FileText className="h-4 w-4 text-accent-purple shrink-0 mt-0.5" />
                    <span className="text-[13.5px] text-zinc-700 group-hover:text-zinc-950 leading-relaxed font-light">
                      Collaborative Care for Mental Health in Low- and Middle-Income Countries: A WHO Health Systems Framework Assessment of Three Programs. <span className="text-accent-purple font-medium underline break-all">https://pmc.ncbi.nlm.nih.gov/articles/PMC5790311/</span>
                    </span>
                  </a>

                  <a
                    href="https://doi.org/10.1007/s41347-024-00389-8"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-start gap-3 p-3.5 rounded-xl bg-white border border-zinc-200/80 hover:border-accent-purple/50 hover:bg-zinc-50 transition-colors group"
                  >
                    <FileText className="h-4 w-4 text-accent-purple shrink-0 mt-0.5" />
                    <span className="text-[13.5px] text-zinc-700 group-hover:text-zinc-950 leading-relaxed font-light">
                      Improving the Quality of Global Mental Health Services with Digital Tools: Best Practices and Lessons Learned from Rural Nepal. <span className="text-accent-purple font-medium underline break-all">https://doi.org/10.1007/s41347-024-00389-8</span>
                    </span>
                  </a>

                  <a
                    href="https://doi.org/10.1186/s12982-025-00645-z"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-start gap-3 p-3.5 rounded-xl bg-white border border-zinc-200/80 hover:border-accent-purple/50 hover:bg-zinc-50 transition-colors group"
                  >
                    <FileText className="h-4 w-4 text-accent-purple shrink-0 mt-0.5" />
                    <span className="text-[13.5px] text-zinc-700 group-hover:text-zinc-950 leading-relaxed font-light">
                      Addressing challenges for psychotherapy supervision in global mental health through experiential learnings from rural Nepal. <span className="text-accent-purple font-medium underline break-all">https://doi.org/10.1186/s12982-025-00645-z</span>
                    </span>
                  </a>

                  <a
                    href="https://pubmed.ncbi.nlm.nih.gov/37858578/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-start gap-3 p-3.5 rounded-xl bg-white border border-zinc-200/80 hover:border-accent-purple/50 hover:bg-zinc-50 transition-colors group"
                  >
                    <FileText className="h-4 w-4 text-accent-purple shrink-0 mt-0.5" />
                    <span className="text-[13.5px] text-zinc-700 group-hover:text-zinc-950 leading-relaxed font-light">
                      Evidence-based, multilevel interventions for sustained behaviour change. <span className="text-accent-purple font-medium underline break-all">https://pubmed.ncbi.nlm.nih.gov/37858578/</span>
                    </span>
                  </a>
                </div>
              </div>
          ...
          <section id="test" className="scroll-mt-24 space-y-10 border-b border-zinc-100 pb-16">
            ...
            {activeTestSubTab === "tested" && (
              <div className="space-y-8 animate-in fade-in duration-300">
                ...
                <div className="p-8 bg-zinc-50/60 border border-zinc-200/80 rounded-3xl space-y-5 shadow-xs">
                  ...
                  <div className="pt-4 border-t border-zinc-200/80 space-y-2">
                    ...
                    <div className="grid grid-cols-1 gap-2">
                      ...
                      <Link href="/solutions/scale" className="text-[13.5px] font-semibold text-secondary-blue hover:underline pt-1 inline-flex items-center gap-1">
                        <span>Also link to [Strengthening Community Health Systems Through Longitudinal Care]</span>
                        <span>&rarr;</span>
                      </Link>
                    </div>
                  </div>
                ...
                <div className="p-8 bg-zinc-50/60 border border-zinc-200/80 rounded-3xl space-y-5 shadow-xs">
                  <h3 className="text-2xl font-bold text-zinc-950">
                    Perinatal-MH: Integrating perinatal mental health into Community Health Worker-led longitudinal care
                  </h3>
                  <div className="space-y-3 text-[15.5px] text-zinc-700 leading-relaxed font-light text-justify sm:text-left">
                    <p>
                  ...
                  <div className="pt-4 border-t border-zinc-200/80 space-y-2">
                    ...
                    <div className="grid grid-cols-1 gap-2">
                      ...
                      <div className="pt-1 flex flex-wrap gap-4 text-[13.5px] font-semibold text-secondary-blue">
                        ...
                        <Link href="/solutions/scale" className="hover:underline">
