      ...
      projects: [
        {
          ...
          publications: [
            ...
            {
              title: "Cross-link: COMMIT — Improving treatment compliance using mHealth app",
        ...
        },
        {
          ...
          publications: [
            ...
            {
              title: "Cross-link: BECOME — Bringing integrated mental health and NCD care closer to home",
