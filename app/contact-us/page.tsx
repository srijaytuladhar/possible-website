...
import { Mail, Phone, MapPin, Building, Send, CheckCircle2, MessageSquare } from "lucide-react";
...
export default function ContactUs() {
  ...
  return (
    <div className="mx-auto max-w-4xl w-full px-6 sm:px-8 py-16 flex flex-col flex-1 space-y-16 animate-in fade-in duration-300">
      ...
      {/* 3. Send Us a Message Button (Redirects to Form below) */}
      <div className="flex justify-center pt-4">
        <button
          onClick={handleScrollToForm}
          className="inline-flex items-center gap-2 rounded-full bg-primary-pink px-8 py-4 font-equip font-semibold text-[15px] text-white shadow-lg shadow-primary-pink/25 hover:bg-primary-pink/90 hover:shadow-primary-pink/35 hover:-translate-y-0.5 active:translate-y-0 transition-all cursor-pointer"
        >
      ...
      {/* 4. Send Us a Message Form Section */}
      <section id="message-form" className="bg-zinc-50 border border-zinc-100 rounded-3xl p-8 sm:p-10 shadow-sm scroll-mt-24">
        <h3 className="text-2xl font-light text-zinc-950 mb-6 uppercase tracking-wider text-center">
          Send Us a Message
        </h3>
