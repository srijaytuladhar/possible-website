...
export default function Header() {
  ...
  const navItems: NavItem[] = [
    { name: "Home", href: "/" },
    {
      ...
      href: "/publications",
      submenu: [
        { name: "Impact Report", href: "/publications?tab=impact-report", tabKey: "impact-report" },
        { name: "Research Paper", href: "/publications?tab=research-paper", tabKey: "research-paper" },
        { name: "Research Brief", href: "/publications?tab=research-brief", tabKey: "research-brief" },
        { name: "Financials", href: "/publications?tab=financials", tabKey: "financials" },
      ],
    },
    {
      name: "Get Involved",
      href: "/get-involved",
      submenu: [
        { name: "Our Team", href: "/get-involved?tab=our-team", tabKey: "our-team" },
